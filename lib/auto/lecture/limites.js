...
// "format", "taille", "pages".
export function lisibleAutomatiquement({ typeMime, taille, pages = null, formats = FORMATS_LISIBLES }) {
  if (!formats.includes(typeMime)) return { lisible: false, raison: "format" };
