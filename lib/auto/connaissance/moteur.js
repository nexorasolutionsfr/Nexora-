...
function regleCritair(vehicule) {
  ...
  return {
    ...
    valeur: { classe: r.classe, libelle: r.libelle, couleur: r.couleur, norme: r.norme, fondement: r.fondement },
    faitsUtilises: faits,
...
function regleCampagnes(vehicule, campagnes) {
  ...
  if (r.etat === "aucune_fiche") {
    return {
      ...base,
      etat: "non_applicable",
      resume: "Aucune fiche publiée ne nomme ce modèle.",
...
export const PROGRAMMES = [
  {
    ...
    portee: "Tesla Model 3, tous millésimes. La page ajoute : « s'ils s'appliquent à votre véhicule ».",
    operations: [
  ...
  },
  {
    ...
    portee: "Tesla Model Y, tous millésimes. La page ajoute : « s'ils s'appliquent à votre véhicule ».",
    operations: [
      { libelle: "Liquide de frein : contrôle (remplacement au besoin)", intervalle: { mois: 48 }, condition: "Remorquage, descentes de montagne, conduite sportive, environnement chaud et humide : contrôles plus fréquents." },
...
function regleEntretien(vehicule, programmes, reperes) {
  ...
  if (programme) {
    return {
      ...
      faitsUtilises: [{ cle: "marque_modele", valeur: `${vehicule.marque} ${vehicule.modele}` }],
      limites: [
        "Les intervalles publiés valent pour des usages types, et la liste n'est pas présentée comme exhaustive.",
        "Nexora ne sait pas quand chacune de ces opérations a été faite sur votre voiture : enregistrez-les et elle suivra les échéances.",
      ],
    };
  }
  ...
  return {
    ...
    resume: intervalleRenseigne
      ? "Nexora n'a pas de programme publié pour cette version : votre suivi repose sur l'intervalle de votre carnet."
      : "Nexora n'a pas de programme publié pour cette version. L'intervalle se lit sur votre carnet d'entretien.",
