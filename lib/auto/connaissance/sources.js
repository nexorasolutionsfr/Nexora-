...
export const SOURCES = {
  ...
  "tesla-entretien-model3": {
    titre: "Intervalles d'entretien du véhicule — Model 3",
    editeur: "Tesla",
    url: "https://service.tesla.com/docs/Public/diy/model3/fr_fr/GUID-A84FDD77-7A8C-42F6-9385-E3F9CEE245A4.html",
    version: "documentation de service, locale fr_fr, relue le 20 septembre 2026",
    verifie_le: "2026-09-20",
    // Vérifié à la lecture : la page NE NOMME AUCUN MARCHÉ. Son adresse porte
    // la locale fr_fr, et son contenu mentionne la Chine comme variante
    // locale — c'est donc une liste internationale à variantes, pas une liste
    // française. Ne pas lui prêter une portée qu'elle ne revendique pas.
    portee: "Tesla Model 3. La page ne nomme aucun marché et introduit chaque point par « s'ils s'appliquent à votre véhicule ».",
    droits:
      "Conditions d'utilisation NON CONSULTÉES : les pages légales de tesla.com refusent les requêtes automatisées (HTTP 403, constaté le 20 septembre 2026). Un accès public ne vaut pas autorisation de redistribution. Nexora cite les intervalles comme des faits, avec leur source et un lien vers la page ; elle ne republie pas la page. À faire confirmer si la couverture s'élargit.",
  },
  "tesla-entretien-modely": {
    titre: "Intervalles d'entretien du véhicule — Model Y",
    editeur: "Tesla",
    url: "https://service.tesla.com/docs/Public/diy/modely/fr_fr/GUID-A84FDD77-7A8C-42F6-9385-E3F9CEE245A4.html",
    version: "documentation de service, locale fr_fr, relue le 20 septembre 2026",
    verifie_le: "2026-09-20",
    // Vérifié à la lecture : la page NE NOMME AUCUN MARCHÉ. Son adresse porte
    // la locale fr_fr, et son contenu mentionne la Chine comme variante
    // locale — c'est donc une liste internationale à variantes, pas une liste
    // française. Ne pas lui prêter une portée qu'elle ne revendique pas.
    portee: "Tesla Model Y. La page ne nomme aucun marché et introduit chaque point par « s'ils s'appliquent à votre véhicule ».",
    droits:
      "Conditions d'utilisation NON CONSULTÉES : les pages légales de tesla.com refusent les requêtes automatisées (HTTP 403, constaté le 20 septembre 2026). Un accès public ne vaut pas autorisation de redistribution. Nexora cite les intervalles comme des faits, avec leur source et un lien vers la page ; elle ne republie pas la page. À faire confirmer si la couverture s'élargit.",
  },
  "volkswagen-plan-entretien": {
    titre: "Plan d'entretien Volkswagen",
    editeur: "Volkswagen France",
    url: "https://www.volkswagen.fr/fr/entretenir-ma-volkswagen/entretien-et-pieces/plan-entretien.html",
    version: "page publique",
    verifie_le: "2026-09-20",
    // La portée est le point important : c'est ce qui en fait un repère et non
    // un programme.
    portee: "« Votre Volkswagen » — la page ne nomme aucun modèle, aucune motorisation.",
    droits: "Page publique de la marque. Aucune clause de réutilisation relevée dans ses mentions légales.",
  },
};
