...
export const SOURCES = {
  ...
  "tesla-entretien-model3": {
    ...
    version: "page publique fr_FR",
    verifie_le: "2026-09-20",
    portee: "Tesla Model 3. La page précise « s'ils s'appliquent à votre véhicule ».",
    droits:
      "Conditions de réutilisation non examinées. Nexora cite les intervalles publiés comme des faits, avec leur source et un lien vers la page ; elle ne recopie pas la page.",
  },
  "tesla-entretien-modely": {
    ...
    version: "page publique fr_FR",
    verifie_le: "2026-09-20",
    portee: "Tesla Model Y. La page précise « s'ils s'appliquent à votre véhicule ».",
    droits:
      "Conditions de réutilisation non examinées. Nexora cite les intervalles publiés comme des faits, avec leur source et un lien vers la page ; elle ne recopie pas la page.",
  },
