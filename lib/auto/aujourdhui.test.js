...
import { choisirVoiture, etatAujourdhui, kilometrageFrais } from "./aujourdhui.js";
...
test("kilometrageFrais : un relevé du jour ou de la semaine n'est pas à redemander", () => {
  assert.equal(kilometrageFrais({ date: "2026-09-18" }, "2026-09-18"), true);
  assert.equal(kilometrageFrais({ date: "2026-09-10" }, "2026-09-18"), true);
  assert.equal(kilometrageFrais({ date: "2026-08-01" }, "2026-09-18"), false);
  assert.equal(kilometrageFrais(null, "2026-09-18"), false);
  assert.equal(kilometrageFrais({ date: null }, "2026-09-18"), false);
  // Une date dans le futur ne vaut pas fraîcheur : on ne devine pas.
  assert.equal(kilometrageFrais({ date: "2026-10-01" }, "2026-09-18"), false);
});
