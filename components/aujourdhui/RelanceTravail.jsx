...
export default function RelanceTravailModal({ relance, travail, onFermer, onChange, onToast }) {
  ...
  return (
    <Portail>
      <div className="fixed inset-0 bg-black/40 z-[60] flex items-stretch sm:items-center sm:justify-center" role="dialog" aria-modal="true" aria-label="Relance du travail différé">
        <div className="bg-white w-full sm:max-w-xl sm:rounded-2xl sm:max-h-[92vh] h-full sm:h-auto flex flex-col overflow-hidden">
          <div className="flex items-start justify-between gap-3 px-4 py-3 border-b border-slate-100 shrink-0">
            ...
            <button type="button" onClick={onFermer} aria-label="Fermer" className="shrink-0 w-9 h-9 rounded-xl border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"><X size={16} /></button>
          </div>
