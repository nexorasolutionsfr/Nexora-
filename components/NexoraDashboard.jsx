...
// VIEWS
// =====================================================================================
function DashboardView({ stats, propositions, setView, onSelectAppt, loading, rendezVous, demandes, clients, garageData, aiStats, timeline, automationEvents, factures = [] }) {
...
function FacturesView({ rendezVous, factures, prestations, garageData, onGenerer, onMarquerPayee, onSauvegarder }) {
  ...
  const categoriesDisponibles = [...new Set(facturesEnrichies.map((f) => f.categorie))];
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex items-center gap-2 bg-slate-50 rounded-xl px-3 py-1.5 border border-slate-200">
              ...
              <input
                ...
                className="bg-transparent text-[12.5px] outline-none w-40"
              />
            </div>
...
/>
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="p-5 md:p-8">
          {view === "dashboard" && <DashboardView stats={stats} propositions={propositions} setView={setView} onSelectAppt={setSelectedAppt} loading={loading} rendezVous={rendezVous} demandes={demandes} clients={clients} garageData={garageData} aiStats={aiStats} timeline={activityTimeline} automationEvents={automationEvents} factures={factures} />}
