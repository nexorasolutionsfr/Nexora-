...
insert into public.garages (id, owner_user_id, nom_garage, abonnement_actif, acces_motif) values
  (pg_temp.fid('garage_a'), pg_temp.fid('user_a'), 'RECETTE DEVIS LIGNES V1 — GARAGE A', true, 'abonnement'),
  (pg_temp.fid('garage_b'), pg_temp.fid('user_b'), 'RECETTE DEVIS LIGNES V1 — GARAGE B', true, 'abonnement');
